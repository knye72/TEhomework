...
-- your result set is temporary and only exists as the result of running a query. next week we get back into C# and we can bring the data back to the application.
...
--SELECT city_name FROM  city WHERE population>10000;
...
-- % is a wildcard/match all character. A% means satrts with A, %A ends with A
