    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            your phone.
            */
            int percentageOfBatteryLeft = 90;
            ...
            */
            string saw = "Saw";
            saw += 2; //implicit conversion - the compiler thinks we want to concatenate, which turns 2 into a string
            ...
            */
            double fiveByTwo = 5 / 2; //treating these as integers so it returns an integer, truncated after the decimal.
            Console.WriteLine(fiveByTwo);

            /*
            21. What is 5.0 divided by 2?
            */
            fiveByTwo = (float)5 / 2; //makes it into a float
            Console.WriteLine(fiveByTwo);
            ...
            */
            ...
            Console.WriteLine("Double balance: " + bankBalance * 2); //more implicit conversion
            ...
            */
            ...
            int smallNum = 3;
            int bigNum = 1000000000; // no commas
            //Console.WriteLine(smallNum * bigNum); result is too big for an int so it overflows and counts from the negative end
            long threeBillion = smallNum * (long)bigNum; //turning bigNum into a long
            ...
            */
            ...
            Console.WriteLine("Are we done with these exercises? " + isDoneWithExercises);
