...
namespace Exercises
{
    public partial class Exercises
    {
        ...
        public double IsItOnSale(string itemNumber)
        {
            ...
            if (itemNumber == null || itemNumber == "" || itemNumber == " ")
            {
                return 0.00;
            }

            string lowerCaseItem = itemNumber.ToLower();

            if (itemDictionary.ContainsKey(lowerCaseItem)){
                return itemDictionary[lowerCaseItem];
            }
            return 0.0;
        }
    }
