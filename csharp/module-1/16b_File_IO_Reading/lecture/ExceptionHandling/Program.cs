    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            catch (IndexOutOfRangeException e) //type of exception -> IndexOutOfRange. exception name -> e
            {
                // Flow of control resumes here after the Exception is thrown
                Console.WriteLine("XXX   Uh-oh, something went wrong...   XXX");
                Console.WriteLine(e.Message); //usually don't send these to users since they usually don't know what it means.
            }
...
*/
        ...
        private static double Withdraw(double v)
        {
