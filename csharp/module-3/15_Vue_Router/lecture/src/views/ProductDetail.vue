...
export default {
    ...
    computed: {
        product() {
            ...
            //use the getter for product in the store so that it always gives me the product with the active product ID
            //this lets the store take care of finding out which product is the active product
            //it also means you don't have to do the same thing a bunch of times.
        }
    },
    ...
    //so that this code runs before the view gets dispalyed in the DOM.
}
